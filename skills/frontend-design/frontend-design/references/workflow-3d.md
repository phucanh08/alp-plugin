...
- Activate `alp:threejs` skill for 3D and WebGL expertise
- Have `alp:ai-multimodal` skill ready for asset generation

## Initial Research
Run `alp:ui-ux-pro-max` searches:
```bash
...
Use `alp:ai-multimodal` skill for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites
- Video backgrounds

Use `alp:media-processing` skill for:
