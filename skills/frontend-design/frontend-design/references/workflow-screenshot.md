...
## Prerequisites
- Activate `alp:ui-ux-pro-max` skill first for design intelligence
- Have `alp:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `alp:ai-multimodal` skill to extract:
...
### 4. Generate Assets
Use `alp:ai-multimodal` skill:
- Generate images, icons, backgrounds
- Verify generated assets match design
- Remove backgrounds if needed with `alp:media-processing`
