...
Activate the alp:chrome-devtools skill.
...
## Workflow
- Use `alp:plan` skill to organize the test plan & report
...
- Use `alp:ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/alp:preview`
