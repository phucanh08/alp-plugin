...
- Otherwise use `alp:repomix` to generate fresh codebase summary
- Use `/alp:scout` or `/alp:scout ext` to find relevant files
- Use `alp:docs-seeker` skill for package/plugin documentation
