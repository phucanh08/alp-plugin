...
2. If no logo provided: generate with `alp:ai-multimodal` skill
3. Screenshot wireframes with `alp:chrome-devtools` → save to `./docs/wireframes/`
...
Activate **alp:plan** skill: `/alp:plan --fast <requirements>`
