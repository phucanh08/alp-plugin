...
Handled by **alp:cook** skill. Bootstrap-specific notes:
...
- Asset pipeline: `alp:ai-multimodal` (generate/analyze) → `imagemagick` (crop/resize) → background removal if needed
