...
1. **Screenshots provided** → Use `alp:ai-multimodal` skill for detailed context analysis
2. **Videos provided** → Use `alp:ai-multimodal` video-analysis for comprehensive context
