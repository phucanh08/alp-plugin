...
```bash
python .claude/scripts/alp-help.py "$ARGUMENTS"
```

## Output Type Detection

The script outputs a type marker on the first line: `@ALP_OUTPUT_TYPE:<type>`

**Read this marker and adjust your presentation accordingly:**

### `@ALP_OUTPUT_TYPE:comprehensive-docs`
...
### `@ALP_OUTPUT_TYPE:command-details`
...
### `@ALP_OUTPUT_TYPE:search-results`
...
### `@ALP_OUTPUT_TYPE:task-recommendations`
