...
## Visual Aids
- Use `/alp:preview --explain` when explaining unfamiliar code patterns or complex logic
- Use `/alp:preview --diagram` for architecture diagrams and data flow visualization
- Use `/alp:preview --slides` for step-by-step walkthroughs and presentations
- Use `/alp:preview --ascii` for terminal-friendly diagrams (no browser needed to understand)
